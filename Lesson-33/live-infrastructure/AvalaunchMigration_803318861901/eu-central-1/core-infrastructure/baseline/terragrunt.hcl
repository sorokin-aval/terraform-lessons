...
terraform {
  source = "git::https://code.rbi.tech/raiffeisen/ua-avalaunch-terraform-modules.git//aws-baseline?ref=baseline_v2.11.0"
//    source = "../../../../../../ua-avalaunch-terraform-modules//aws-baseline"
}
