    ...
    "Statement": [
        {
            ...
            "Resource": [
                ...
                "arn:aws:s3:::${local.s3_prefix}-transmaster/ods/issuing2_0.izd_slip/*",
                "arn:aws:s3:::${local.s3_prefix}-iscard/ods/ic.extopsarch/*",
                "arn:aws:s3:::${local.s3_prefix}-iscard/ods/ic.cardsglobal/*",
                "arn:aws:s3:::${local.s3_prefix}-iscard/ods/ic.accounts/*",
                "arn:aws:s3:::${local.s3_prefix}-iscard/ods/ic.agreements/*",
                "arn:aws:s3:::${local.s3_prefix}-iscard/ods/ic.conditclass/*",
                "arn:aws:s3:::${local.s3_prefix}-iscard/ods/ic.privateclients/*",
                "arn:aws:s3:::${local.s3_prefix}-iscard/ods/ic.extopclass/*",
                "arn:aws:s3:::${local.s3_prefix}-ataccama/ods/rdm.uniq_city_tm/*",
                "arn:aws:s3:::${local.s3_prefix}-ataccama/ods/rdm.zone_region/*",
                "arn:aws:s3:::${local.s3_prefix}-transmaster/ods/issuing2_0.izd_pre_processing_row/*"
            ]
        },
        {
            "Sid": "02listsources",
