...
inputs = {
  ...
  ingress_with_cidr_blocks = [
    ...
    },
    {
      ...
      to_port     = 9447
      protocol    = "6"
      description = "Access from ESB (Message Broker)"
      cidr_blocks = "10.226.118.52/32,10.226.119.23/32"
    }
  ]
  ...
  ingress_with_source_security_group_id = [
    {
      ...
      to_port                  = 9447
      protocol                 = "6"
      description              = "Access to Aplication servers from ALB"
      source_security_group_id = dependency.vatauto_alb_sg_id.outputs.security_group_id
    }
  ]
