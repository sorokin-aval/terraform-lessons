...
dependency "sg_jamfadcs" {
    config_path = find_in_parent_folders("sg/jamfadcs")
}
...
locals {
  tags = {
    ...
    "business:emergency-contact" = "andrii.martsynenko@raiffeisen.ua",
    "platform:backup" = "Daily-3day-Retention",
    "ea:application-id" = "0",
    "ea:application-name" = "Jamf",
    "map-migrated" = "NA",
    "map-dba" = "NA",
    "product" = "JAMF"
...
inputs = {
    ...
    vpc_security_group_ids = [
        ...
        dependency.sg_jamfadcs.outputs.security_group_id,
