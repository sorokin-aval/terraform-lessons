...
inputs = {
  name        = "gitlab-avalaunch-vpces"
  nlb_arns    = ["arn:aws:elasticloadbalancing:eu-central-1:136812256255:loadbalancer/net/gitlab-avalaunch-aval-ee/09e375ae6a0f0871"]
  description = "VPC Endpoint Service for Gitlab AVALaunch"
