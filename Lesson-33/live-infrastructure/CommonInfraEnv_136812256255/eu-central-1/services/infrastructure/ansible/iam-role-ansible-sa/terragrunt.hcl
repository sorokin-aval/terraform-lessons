...
dependency "iam-policy-ansible-sa" {
  config_path = "../iam-policy-ansible-sa"
...
locals {
  ...
  terraform_k8s_name      = "ua-platformsops-ansible-roles"
...
inputs = {
  ...
  role_policy_arns = {
    sts = dependency.iam-policy-ansible-sa.outputs.arn
  }
  tags = local.tags_map
}
