...
inputs = {
  ...
  ingress = [
    ...
    { from_port : 22, to_port : 22, protocol : "tcp", security_groups : [dependency.sg.outputs.security_group_id], description : "was-sake-sg" },
    { from_port : 22, to_port : 22, protocol : "tcp", security_groups : [dependency.sg-stp.outputs.security_group_id], description : "stp-sg" },
    { from_port : 2800, to_port : 9999, protocol : "tcp", security_groups : [dependency.sg.outputs.security_group_id], description : "was-sake-sg" },
    { from_port : 2800, to_port : 9999, protocol : "tcp", security_groups : [dependency.sg-stp.outputs.security_group_id], description : "stp-sg" },
    { from_port : 11005, to_port : 11099, protocol : "tcp", security_groups : [dependency.sg.outputs.security_group_id], description : "was-sake-sg" },
    { from_port : 11005, to_port : 11099, protocol : "tcp", security_groups : [dependency.sg-stp.outputs.security_group_id], description : "stp-sg" },
