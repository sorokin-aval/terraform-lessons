...
inputs = {
  ...
  ebs_optimized   = false
  tags            = merge(local.app_vars.locals.tags, { map-migrated = "d-server-026xfb85fcf7zx" })
  ...
  ingress = [
    ...
    { from_port : 1521, to_port : 1526, protocol : "tcp", cidr_blocks : local.account_vars.locals.ips["oracle_db_mpcs"], description : "oracle_db_mpcs" },
    { from_port : 1575, to_port : 1575, protocol : "tcp", cidr_blocks : local.account_vars.locals.ips["oracle_db_mpcs"], description : "oracle_db_mpcs" },
