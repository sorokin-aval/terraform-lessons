...
inputs = {
  ...
  ingress_cidr_blocks = concat(
    ...
    local.account_vars.locals.dbs["hollywood-manhattan"],
  )
  ...
  egress_with_cidr_blocks = [
    ...
    { from_port : 1434, to_port : 1434, protocol : "udp", cidr_blocks : local.account_vars.locals.dbs["hollywood-manhattan"][0], description : "hollywood-manhattan" },
    { from_port : 1440, to_port : 1440, protocol : "tcp", cidr_blocks : local.account_vars.locals.dbs["hollywood-manhattan"][0], description : "hollywood-manhattan" },
    { from_port : 5022, to_port : 5023, protocol : "tcp", cidr_blocks : local.account_vars.locals.dbs["hollywood-manhattan"][0], description : "hollywood-manhattan" },
  ]
}
