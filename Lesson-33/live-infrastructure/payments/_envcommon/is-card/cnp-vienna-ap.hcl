...
inputs = {
  ...
  egress = [
    ...
    { from_port : 9041, to_port : 9041, protocol : "tcp", cidr_blocks : local.account_vars.locals.ips["pos-gateway-vienna"], description : "pos-gateway-vienna" },
    ...
    { from_port : 1575, to_port : 1575, protocol : "tcp", cidr_blocks : local.account_vars.locals.ips["iscardb.todb"], description : "iscardb.todb" },
  ]
  ...
  tg_entries = {
    "iscv-8443" = {
      target_port  = 8443
      target_group = dependency.tg-alb.outputs.target_groups["iscv-8443"].arn
    },
    "iscv-8445" = {
      target_port  = 8445
      target_group = dependency.tg-alb.outputs.target_groups["iscv-8445"].arn
    },
    "iscv-8447" = {
      target_port  = 8447
      target_group = dependency.tg-alb.outputs.target_groups["iscv-8447"].arn
    },
  }
}
