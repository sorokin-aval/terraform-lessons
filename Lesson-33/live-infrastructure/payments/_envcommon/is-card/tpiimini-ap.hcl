...
inputs = {
  ...
  egress = [
    ...
    { from_port : 6565, to_port : 6600, protocol : "tcp", cidr_blocks : local.account_vars.locals.ips["tpii-advice-host"], description : "TPII Advice Host" },
    ...
    { from_port : 80, to_port : 80, protocol : "tcp", cidr_blocks : local.account_vars.locals.ips["satellite-c"], description : "satellite-c" },
    { from_port : 443, to_port : 443, protocol : "tcp", cidr_blocks : local.account_vars.locals.ips["satellite-c"], description : "satellite-c" },
