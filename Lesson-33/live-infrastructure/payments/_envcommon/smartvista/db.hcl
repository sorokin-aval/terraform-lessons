...
inputs = {
  ...
  ingress = [
    ...
    { from_port : 1521, to_port : 1526, protocol : "tcp", cidr_blocks : local.account_vars.locals.ips["oracle_db_svcg"], description : "oracle_db_svcg" },
    { from_port : 1575, to_port : 1575, protocol : "tcp", cidr_blocks : local.account_vars.locals.ips["oracle_db_svcg"], description : "oracle_db_svcg" },
