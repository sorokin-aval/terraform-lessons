...
inputs = {
  ...
  ingress = [
    ...
    { from_port : 1521, to_port : 1526, protocol : "tcp", cidr_blocks : local.account_vars.locals.pools["ho-pool-devchannels"], description : "ho-pool-devchannels" },
    { from_port : 1575, to_port : 1575, protocol : "tcp", cidr_blocks : local.account_vars.locals.pools["ho-pool-devchannels"], description : "ho-pool-devchannels" },
    { from_port : 1521, to_port : 1526, protocol : "tcp", cidr_blocks : local.account_vars.locals.ips["lepte-in-data"], description : "lepte-in-data" },
