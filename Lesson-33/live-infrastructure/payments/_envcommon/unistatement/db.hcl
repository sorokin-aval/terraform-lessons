...
inputs = {
  ...
  ingress = [
    ...
    { from_port : 5432, to_port : 5432, protocol : "tcp", cidr_blocks : local.account_vars.locals.ips["psgl-unistatement"], description : "psgq-on-premise" },
    { from_port : 8008, to_port : 8008, protocol : "tcp", cidr_blocks : local.account_vars.locals.ips["psgl-unistatement"], description : "psgq-on-premise" },
    { from_port : 2379, to_port : 2379, protocol : "tcp", cidr_blocks : local.account_vars.locals.ips["psgl-unistatement"], description : "psgq-on-premise" },
  ]
  egress  = [
