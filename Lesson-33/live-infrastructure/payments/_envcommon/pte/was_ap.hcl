...
inputs = {
  ...
  ingress = [
    ...
    { from_port : 9081, to_port : 9081, protocol : "tcp", security_groups : [dependency.alb-sg.outputs.security_group_id], description : "alb-internal" },
    ...
    { from_port : 9443, to_port : 9445, protocol : "tcp", cidr_blocks : local.account_vars.locals.pools["ho-pool-card"], description : "HO-POOL-CARD" },
    ...
    { from_port : 8081, to_port : 8081, protocol : "tcp", cidr_blocks : local.account_vars.locals.pools["ho-pool-card"], description : "HO-POOL-CARD" },
    ...
    { from_port : 9081, to_port : 9081, protocol : "tcp", cidr_blocks : local.account_vars.locals.ips["ibm-mb"], description : "ibm-mb" },
    { from_port : 9443, to_port : 9445, protocol : "tcp", cidr_blocks : local.account_vars.locals.ips["ibm-mb"], description : "ibm-mb" },
  ...
  tg_entries = {
    "vpos-9081" = {
      target_port  = 9081
      target_group = dependency.tg-alb.outputs.target_groups["vpos-9081"].arn
    },
    "pte-9443" = {
      target_port  = 9443
      target_group = dependency.tg-alb.outputs.target_groups["pte-9443"].arn
    },
  }
}
