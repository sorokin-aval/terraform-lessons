...
inputs = {
  ...
  target_groups = [
    ...
    { # Norkom - index 2
      ...
      target_type      = "instance"
      targets = [
        { target_id : dependency.db01-norkom.outputs.ec2_id, port : 1521 },
      ]
    },
    { # Norkom - index 3
      name_prefix      = "nrk-"
    ...
    { # IS-Card - index 4
      ...
      target_type      = "instance"
      targets = [
        { target_id : dependency.db01-is-card.outputs.ec2_id, port : 1521 },
      ]
    },
    { # IS-Card - index 5
      name_prefix      = "isc-"
    ...
    { # TM - index 6
      ...
      target_type      = "instance"
      targets = [
        { target_id : dependency.db01-tm.outputs.ec2_id, port : 1521 },
      ]
    },
    { # TM - index 7
      name_prefix      = "tm-"
