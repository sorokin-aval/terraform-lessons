...
inputs = {
  ...
  sg_rules = [{ type = "ingress", from_port = 8400, to_port = 8403, protocol = "tcp", cidr_blocks = ["10.191.2.184/32"], description = "CommCell bigpoint.ms.aval" },
    ...
    { type = "ingress", from_port = 8400, to_port = 8403, protocol = "tcp", cidr_blocks = ["10.225.116.0/26"], description = "LZ-AVAL_BACKUP_DEV-InternalA" },
    { type = "ingress", from_port = 8400, to_port = 8403, protocol = "tcp", cidr_blocks = ["10.225.116.64/26"], description = "LZ-AVAL_BACKUP_DEV-InternalB" },
    { type = "ingress", from_port = 8400, to_port = 8403, protocol = "tcp", cidr_blocks = ["10.225.116.128/26"], description = "LZ-AVAL_BACKUP_DEV-RestrictedA" },
    { type = "ingress", from_port = 8400, to_port = 8403, protocol = "tcp", cidr_blocks = ["10.225.116.192/26"], description = "LZ-AVAL_BACKUP_DEV-RestrictedB" },
    { type = "egress", from_port = 8400, to_port = 8403, protocol = "tcp", cidr_blocks = ["10.225.116.0/26"], description = "LZ-AVAL_BACKUP_DEV-InternalA" },
    { type = "egress", from_port = 8400, to_port = 8403, protocol = "tcp", cidr_blocks = ["10.225.116.64/26"], description = "LZ-AVAL_BACKUP_DEV-InternalB" },
    { type = "egress", from_port = 8400, to_port = 8403, protocol = "tcp", cidr_blocks = ["10.225.116.128/26"], description = "LZ-AVAL_BACKUP_DEV-RestrictedA" },
    { type = "egress", from_port = 8400, to_port = 8403, protocol = "tcp", cidr_blocks = ["10.225.116.192/26"], description = "LZ-AVAL_BACKUP_DEV-RestrictedB" },
