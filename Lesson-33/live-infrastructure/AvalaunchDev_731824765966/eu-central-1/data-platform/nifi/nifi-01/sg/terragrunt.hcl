...
locals {
  ...
  name         = "${local.tags_map.Nwu}-${local.tags_map.Domain}-${local.tags_map.Environment}-nifi"
}
...
inputs = {
  ...
  security_group_id = dependency.nifi_sg.outputs.sg_id
  tags              = local.tags_map
  ...
  ingress_with_source_security_group_id = [
    ...
    },
    {
      ...
      protocol                 = "TCP"
      description              = "https for nifi"
      source_security_group_id = dependency.nifi_registry.outputs.sg_id
    },
  ]
