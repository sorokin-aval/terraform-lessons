...
inputs = {
  ...
  sg_rules = [{ type = "ingress", from_port = 8400, to_port = 8403, protocol = "tcp", cidr_blocks = ["10.191.2.184/32"], description = "CommCell bigpoint.ms.aval" },
              { type = "ingress", from_port = 22, to_port = 22, protocol = "tcp", cidr_blocks = ["10.0.0.0/8"], description = "SSH" },
	      		  { type = "ingress", from_port = 8400, to_port = 8403, protocol = "tcp", cidr_blocks = ["10.226.103.0/26"], description = "LZ-AVAL_ChannelsIntCritical_Prod_01-InternalA" },
		      	  { type = "ingress", from_port = 8400, to_port = 8403, protocol = "tcp", cidr_blocks = ["10.226.103.64/26"], description = "LZ-AVAL_ChannelsIntCritical_Prod_01-InternalB" },
	      		  { type = "ingress", from_port = 8400, to_port = 8403, protocol = "tcp", cidr_blocks = ["10.226.103.128/26"], description = "LZ-AVAL_ChannelsIntCritical_Prod_01-RestrictedA" },
	      		  { type = "ingress", from_port = 8400, to_port = 8403, protocol = "tcp", cidr_blocks = ["10.226.103.192/26"], description = "LZ-AVAL_ChannelsIntCritical_Prod_01-RestrictedB" },
	      		  { type = "egress", from_port = 8400, to_port = 8403, protocol = "tcp", cidr_blocks = ["10.226.103.0/26"], description = "LZ-AVAL_ChannelsIntCritical_Prod_01-InternalA" },
	      		  { type = "egress", from_port = 8400, to_port = 8403, protocol = "tcp", cidr_blocks = ["10.226.103.64/26"], description = "LZ-AVAL_ChannelsIntCritical_Prod_01-InternalB" },
		      	  { type = "egress", from_port = 8400, to_port = 8403, protocol = "tcp", cidr_blocks = ["10.226.103.128/26"], description = "LZ-AVAL_ChannelsIntCritical_Prod_01-RestrictedA" },
	      		  { type = "egress", from_port = 8400, to_port = 8403, protocol = "tcp", cidr_blocks = ["10.226.103.192/26"], description = "LZ-AVAL_ChannelsIntCritical_Prod_01-RestrictedB" },
