...
locals {
  ...
  domain              = "uat.web.rbua"
  public_domain       = "site-uat.avrb.com.ua"
  ...
  tier1_subnets_list  = ["10.225.110.0/26", "10.225.110.64/26"]
  tier1_subnet_abbr   = "IN"
  tier1_subnet_filter = "*Internal*"

  tier2_subnets_list  = ["10.225.111.0/26", "10.225.111.64/26"]
  tier2_subnet_abbr   = "RT"
  tier2_subnet_filter = "*Restricted*"

  public_subnets_list = ["100.100.33.32/27", "100.100.33.64/27"]
  ...
  salesbase_onprem_subnets_list = [
    { cidr = "10.191.4.202/32",             description = "On-premise Salesbase subnets" },
  ]
  ...
  lb_ssl_cert_arn        = "arn:aws:acm:eu-central-1:115292379528:certificate/6785d0b6-fa6d-4701-8f9a-db81ef07e04c"
  ...
  tag_ami_retention_count_cmsfront  = 1
  tag_ami_expiration_days_cmsfront  = 7
  ...
  cmsfront_autoscaling_options = {
    ...
    instance_ami = "ami-06651822280f59170"
    min_size  = 1
    max_size  = 2
    desired_capacity  = 1
  ...
  webpromo_domain         = "uat.promo.rbua"
  dns_record_lipton_db    = ["lipton-uat.cn5gvcirxbbz.eu-central-1.rds.amazonaws.com"]
  lb_targets_webpromo     = [
    { target_id = "i-07bb1955f87ef02ea" },
  ]
  ...
  int_cmsfront_admin_tg_arn = ["arn:aws:elasticloadbalancing:eu-central-1:115292379528:targetgroup/raifsite-internal-alb-cmsfront/e3532bec7ee92160"]
  int_cmsfront_main_tg_arn  = ["arn:aws:elasticloadbalancing:eu-central-1:115292379528:targetgroup/raifsite-internal-alb-public-cf/31c1e13c4d69c547"]
  pub_cmsfront_sales_tg_arn = ["arn:aws:elasticloadbalancing:eu-central-1:115292379528:targetgroup/raifsite-pub-alb-cmsfront-sales/42d5a278fec84712"]
  pub_cmsfront_main_tg_arn  = ["arn:aws:elasticloadbalancing:eu-central-1:115292379528:targetgroup/raifsite-uat-public-alb-cmsfront/921e35b568b4530a"]

  dns_record_cms_db = ["cmsdb-uat.cn5gvcirxbbz.eu-central-1.rds.amazonaws.com"]
