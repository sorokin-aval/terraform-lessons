...
locals {
  ...
  domain              = "preprod.rbo.rbua"
  public_domain       = "rbo-preprod.avrb.com.ua"
  aval_public_domain  = "rbo.preprod.aval.ua"
  environment_letter  = "PP"
  ...
  lb_ssl_cert_arn         = "arn:aws:acm:eu-central-1:818192193561:certificate/0380f093-cfdb-4cd5-9ca6-ebbb03182660"
  ...
  tier1_subnets_list        = ["10.227.37.0/26"]
  tier1_subnet_abbr         = "TR"
  tier1_subnet_filter       = "*Transfer*"

  tier2_subnets_list        = ["10.227.37.64/26"]
  tier2_subnet_abbr         = "IN"
  tier2_subnet_filter       = "*Internal*"

  tier3_subnets_list        = ["10.227.37.128/26"]
  tier3_subnet_abbr         = "RE"
  tier3_subnet_filter       = "*Restricted*"

  public_subnets_list           = ["100.100.42.160/27", "100.100.42.192/27"]
  ...
  ibm_mq_subnets_list           = ["10.191.194.79/32"]
  ...
  tag_map_migrated_adm      = "d-server-03kj9clzvylind"
  tag_map_migrated_auth     = "d-server-03tabz8ibktvnm"
  tag_map_migrated_is-front = "d-server-00o6ltt8axgaob"
  tag_map_migrated_is-back1 = "d-server-00o6ltt8axgaob"
  tag_map_migrated_is-back2 = "d-server-00o6ltt8axgaob"
  ...
  lb_targets_front = [
    { target_id = "i-00b401f58332c1bb6" },
  ]

  lb_targets_is-front = [
    { target_id = "i-0fe16db51f2fc2264" },
  ]

  lb_targets_auth = [
    { target_id = "i-083e13ad935021ff0" },
  ]

  lb_targets_adm = [
    { target_id = "i-0b463eef1d937dfc4" },
  ]

  lb_targets_db_main = [
    { target_id = "10.227.37.153" },
  ]
  ...
  dns_records_etl_db                   = ["preprod-rbo-etl.cj3fecujrweo.eu-central-1.rds.amazonaws.com."]
  dns_records_arch_db                  = ["preprod-rbo-arch.cj3fecujrweo.eu-central-1.rds.amazonaws.com."]
