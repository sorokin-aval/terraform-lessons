...
inputs = {
  name        = local.name
  description = "Security group for BM instance"
  ...
  egress_with_cidr_blocks = [
    ...
    },
    {
      ...
      to_port     = 4300
      protocol    = "tcp"
      description = "Access to archive database"
      cidr_blocks = local.account_vars.db_subnets
    },
    {
      name        = "AD"
    ...
    },
    {
      ...
      to_port     = 15203
      protocol    = "tcp"
      description = "Access to Transmaster without SSL"
      cidr_blocks = local.account_vars.db_tm_subnets
    },
    {
      name        = "Transmaster SSL Ports"
      from_port   = 15703
      to_port     = 15703
      protocol    = "tcp"
      description = "Access to Transmaster with SSL"
      cidr_blocks = local.account_vars.db_tm_subnets
    },
    {
      name        = "Barsep Ports"
      ...
      to_port     = 1521
      protocol    = "tcp"
      description = "Access to Barsep"
      cidr_blocks = local.account_vars.barsep_subnets
    },
    {
      name        = "Bankmaster Ports"
      from_port   = 1521
      to_port     = 1521
      protocol    = "tcp"
      description = "Access to Bankmaster"
      cidr_blocks = local.account_vars.bm_subnets
    },
    {
      name        = "Bankmaster Gateway Port"
      from_port   = 1521
      to_port     = 1521
      protocol    = "tcp"
      description = "Access to Bankmaster Gateway"
      cidr_blocks = local.account_vars.bmx_subnets
    },
  ]
}
