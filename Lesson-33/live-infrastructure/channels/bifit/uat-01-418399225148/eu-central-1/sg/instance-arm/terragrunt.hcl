...
inputs = {
  name        = local.name
  description = "Security group for ARM instance"
  ...
  ingress_with_cidr_blocks = [
    {
      ...
      to_port     = 9633
      protocol    = "tcp"
      description = "Allow access to application from account private subnets"
    ...
    },
    {
      ...
      to_port     = 9633
      protocol    = "tcp"
      description = "Allow access to application from RBUA private subnets"
    ...
    },
    {
      ...
      to_port     = 443
      protocol    = "tcp"
      description = "Allow HTTPS access from account private subnets"
      cidr_blocks = local.account_vars.account_subnets
    },
    {
      name        = "HTTPS"
      ...
      to_port     = 443
      protocol    = "tcp"
      description = "Allow HTTPS access from RBUA subnets"
      cidr_blocks = local.account_vars.rbua_private_subnets
    },
    {
      name        = "RDP"
  ...
  egress_with_cidr_blocks = [
    ...
    },
    {
      ...
      to_port     = 9633
      protocol    = "tcp"
      description = "Access to application via ELBs"
      cidr_blocks = local.account_vars.account_subnets
    },
  ]
}
