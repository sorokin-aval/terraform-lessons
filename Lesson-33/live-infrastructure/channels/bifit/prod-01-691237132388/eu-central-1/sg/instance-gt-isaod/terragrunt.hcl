...
inputs = {
  name        = local.name
  description = "Security group for Gateway Isaod instance"
  ...
  ingress_with_cidr_blocks = [
    ...
    },
    {
      ...
      to_port     = 9633
      protocol    = "tcp"
      description = "Access from technology private IP pool"
      cidr_blocks = local.account_vars.tech_support_subnets
    },
    {
      name        = "Zabbix Ping"
      from_port   = -1
  ...
  egress_with_cidr_blocks = [
    ...
    },
    {
      ...
      to_port     = 65535
      protocol    = "tcp"
      description = "RPC ports to technology private IP pool"
      cidr_blocks = local.account_vars.tech_support_subnets
    },
    {
      name        = "RPC"
    ...
    },
    {
      ...
      to_port     = 9633
      protocol    = "tcp"
      description = "Access to ARM non-prod"
