...
locals {
  name         = "SG-RBUA-${local.account_vars.environment_letter}-LIAInstanceOTP"
...
inputs = {
  name        = local.name
  description = "Security group for the OTP instance"
  ...
  ingress_with_cidr_blocks = [
    ...
    },
    {
      ...
      cidr_blocks = local.account_vars.inbound_otp_subnets
    },
    {
      name        = "SSH - Ansible"
      from_port   = 22
